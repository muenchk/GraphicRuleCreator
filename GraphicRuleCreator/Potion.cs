...
namespace GraphicRuleCreator
{
    public class Potion
    {
        ...
        public string Effect5 { get; set; } = "";
        public int Duration5 { get; set; } = 0;
        public double Magnitude5 { get; set; } = 0;
        public string Effect6 { get; set; } = "";
        public int Duration6 { get; set; } = 0;
        public double Magnitude6 { get; set; } = 0;
